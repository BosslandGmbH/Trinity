...
//using ItemQuality = Zeta.Game.Internals.Actors.ItemQualityLevel;
//using Logger = Trinity.Technicals.Logger;


//namespace Trinity.Framework.Actors
//{
//    public interface TrinityItem
//    {
//        int AcdId { get; }
//        int AnnId { get; }
//        int ActorSnoId { get; }
...
//    public class TrinityItem : IComparable, TrinityItem
//    {
...
//        public TrinityItem(IntPtr ptr) : this(MemoryWrapper.Create<ActorCommonData>(ptr))
//        {

//        }

//        public TrinityItem(ActorCommonData acd)
//        {
...
//        public void Refresh()
//        {
//            Refresh(Core.Actors.GetAcdByAnnId(AnnId));
//        }
...
//        {
//            var other = obj as TrinityItem;
//            return other != null && other.AnnId == AnnId;
//        }

//        protected bool Equals(TrinityItem other)
//        {
...
//            //if (ActorUtils.IsFullyValid(acdItem))
//            //{
//            //    return acdItem.Drop();
//            //}
//            return false;
...
//        {
//            //var acdItem = GetAcdItem();
//            //if (ActorUtils.IsFullyValid(acdItem) && ActorUtils.IsFullyValid(gem))
//            //{
//            //    acdItem.Socket(gem);
//            //}
//        }

//        private static bool IsFullyValid(ACDItem acdItem)
//        {
...
//        {
//            return Core.Actors.GetAcdItemByAnnId(AnnId);
//        }
