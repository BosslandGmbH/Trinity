...
//        public static float MinDistance = PlayerMover.IsBlocked || CombatBase.IsCurrentlyAvoiding || HasInfiniteCasting
//            ? 0
//            : Combat.Targeting.CurrentTarget != null &&
//              (Combat.Targeting.CurrentTarget.Type == TrinityObjectType.Item || Combat.Targeting.CurrentTarget.IsNpc ||
...
//            if (Combat.Targeting.CurrentTarget != null && Combat.Targeting.CurrentTarget.Distance < _interactDistance &&
//                (Combat.Targeting.CurrentTarget.Type == TrinityObjectType.Item || Combat.Targeting.CurrentTarget.IsNpc ||
//                 Combat.Targeting.CurrentTarget.Type == TrinityObjectType.Shrine))
//                return false;
...
//                if (Combat.Targeting.CurrentTarget?.Type == TrinityObjectType.Item && destinationDistance < 20f)
//                    return false;
