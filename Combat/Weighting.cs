...
namespace Trinity
{
    public partial class TrinityPlugin
    {
        ...
        {
            public static void RefreshDiaGetWeights(List<TrinityActor> objects)
            {
                using (new PerformanceLogger("RefreshDiaObjectCache.Weighting"))
                {
                    ...
                    if (Settings.Combat.Misc.GoblinPriority == GoblinPriority.Kamikaze)
                    {
                        ...
                        if (goblin != null && !isStuck && !PlayerMover.IsCompletelyBlocked && !Core.Grids.Avoidance.IsIntersectedByFlags(Player.Position, goblin.Position, AvoidanceFlags.ClosedDoor))
                        {
                            ...
                            case TrinityObjectType.Unit:
                                {
                                    ...
                                    if (Player.CurrentSceneSnoId == 28768 && cacheObject.ActorSnoId == (int)SNOActor.x1_Tentacle_Goatman_Melee_A && !cacheObject.IsMinimapActive)
                                    {
                            ...
                            case TrinityObjectType.Item:
                                {
                                    ...
                                    if (Player.IsInTown)
                                    {
                                        ...
                                        if (TrinityItem != null)
                                        {
                                            if (Settings.Loot.Pickup.DontPickupInTown && !TrinityItem.IsItemAssigned)
                                            {
                            ...
                            case TrinityObjectType.ProgressionGlobe:
                                {
                                    ...
                                    if (Settings.Combat.Misc.IgnoreNormalProgressionGlobes && DataDictionary.NormalProgressionGlobeSNO.Contains(cacheObject.ActorSnoId))
                                    {
                                        cacheObject.WeightInfo += $"Ignoring {cacheObject.InternalName} because of settings.";
                                        break;
                                    }

                                    if (Settings.Combat.Misc.IgnoreGreaterProgressionGlobes && DataDictionary.GreaterProgressionGlobeSNO.Contains(cacheObject.ActorSnoId))
                                    {
                                        cacheObject.WeightInfo += $"Ignoring {cacheObject.InternalName} because of settings.";
                                        break;
                                    }
                            ...
                            case TrinityObjectType.HealthGlobe:
                                {
                                    ...
                                    if (Player.CurrentHealthPct > CombatBase.EmergencyHealthGlobeLimit)
                                    {
                                        ...
                                        if (
                                            objects.Any(
                                                p => p.Type == TrinityObjectType.Player && p.RActorId != Player.RActorGuid))
                                        {
                                            var minPartyHealth =
                                                objects.Where(
                                                    p =>
                                                        p.Type == TrinityObjectType.Player &&
                                                        p.RActorId != Player.RActorGuid)
            ...
            public static int RecordTargetHistory(TrinityActor bestTarget)
            {
                TargettingInfo info;
                if (bestTarget == null)
                    return 0;
            ...
            /// <returns></returns>
            public static float DistanceForObjectType(TrinityActor cacheObject)
            {
            ...
            public static double GoldFormula(TrinityItem cacheObject)
            {
            ...
            /// <param name="cacheObject"></param>
            /// <returns></returns>
            public static double EliteFormula(TrinityActor cacheObject)
            {
            ...
            /// <param name="cacheObject"></param>
            /// <returns></returns>
            public static double AoENearFormula(TrinityActor cacheObject)
            {
                double weight = 0;
            ...
            /// <param name="cacheObject"></param>
            /// <returns></returns>
            public static double AoEInPathFormula(TrinityActor cacheObject)
            {
                double weight = 0;
            ...
            /// <returns></returns>
            public static double AffixMonsterNearFormula(TrinityActor cacheObject,
            ...
            /// <returns></returns>
            public static double EliteMonsterNearFormula(TrinityActor cacheObject,
            ...
            /// <param name="cacheObject"></param>
            /// <returns></returns>
            public static double ObjectDistanceFormula(TrinityActor cacheObject)
            {
                var multipler = 500d;
            ...
            public static double PackDensityFormula(TrinityActor cacheObject, List<TrinityActor> objects)
            {
            ...
            public static double RiftValueFormula(TrinityActor cacheObject, List<TrinityActor> objects)
            {
                var result = 0d;
            ...
            /// <param name="cacheObject"></param>
            /// <returns></returns>
            public static double UnitHealthFormula(TrinityActor cacheObject)
            {
            ...
            /// <param name="cacheObject"></param>
            /// <returns></returns>
            public static double PathBlockedFormula(TrinityActor cacheObject)
            {
            ...
            /// </summary>
            public static int BlockingObjects(TrinityActor cacheObject)
            {
