...
//        public ActorAttributes(ACD commonData)
//        {
//            Update(commonData);
//        }
...
//        {
//            // Simple GetAttribute calls are using DB attributes API via CommonData.

//            if (commonData == null) return;
//            _commonData = commonData;

//            // AttributeTable/AttribtueEntry is for enumerating a key-value pair of each attribute.            
//            // It is used for logging items, debug investigations and also for more advanced queries 
//            // like finding a duplicate attributes by base ActorAttributeType or ParameterType

//            var group = ZetaDia.Storage.FastAttribGroups[commonData.FastAttribGroupId];
//            var mapPtr = GetMapPtr(group);
//            _table = new AttributeTable(mapPtr);
//        }
...
//        /// </summary>
//        public bool IsValid => _commonData != null && _commonData.IsValid || _table != null && _table.IsValid;
