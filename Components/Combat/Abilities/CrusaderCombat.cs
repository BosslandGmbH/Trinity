...
namespace Trinity.Components.Combat.Abilities
{
    public class CrusaderCombat : CombatBase
    {
        ...
        private static TrinityPower GetBombardPower()
        {
            ...
            {
                CombatManager.TargetHandler.UsePotion();
            }
            ...
            if (CurrentTarget != null)
            {
                ...
                if (IsSteedCharging && !IsCurrentlyAvoiding)
                {
                    ...
                    return new TrinityPower(SNOPower.Walk, 20f, TargetUtil.GetZigZagTarget(CurrentTarget.Position, 35f, true), Trinity.TrinityPlugin.CurrentWorldDynamicId, -1, 0, 1);
                }
            }
