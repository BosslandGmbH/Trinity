...
//            if (Player.ActorClass == ActorClass.Monk && Core.Hotbar.ActiveSkills.Any(s => s.Power == SNOPower.Monk_SevenSidedStrike && s.RuneIndex == 3))
...
//            if (Player.ActorClass == ActorClass.Barbarian && Core.Hotbar.PassiveSkills.Contains(SNOPower.Barbarian_Passive_BoonOfBulKathos))
//            {
...
//        /// </summary>
//        public static SNOPower LastPowerUsed => SpellHistory.LastPowerUsed;
...
//            {
//                return
//                   Trinity.TrinityPlugin.Targets.Any(o => o.IsElite &&
...
//                        Trinity.TrinityPlugin.Targets.Any(o => o.IsBoss);
//            }
//        }
...
//        {
//            get { return Trinity.TrinityPlugin.Settings; }
//        }
...
//                if (Combat.Targeting.CurrentTarget.IsSafeSpot && Core.Avoidance.Avoider.ShouldAvoid)
//                    return true;
...
//                if (Combat.Targeting.CurrentTarget.IsSafeSpot && Core.Avoidance.Avoider.ShouldKite)
//                    return true;
...
//                switch (Combat.Targeting.CurrentTarget.Type)
//                {
...
//        public static TrinityActor CurrentTarget => Combat.Targeting.CurrentTarget;

//        public static TrinityPower CurrentPower => Combat.Targeting.CurrentPower;
...
//                        TargetAcdId = Combat.Targeting.CurrentTarget.AcdId,
//                    };
//                }
//                return new TrinityPower();
//            }
...
//        {
//            return Core.Buffs.HasBuff(power);
//        }
...
//        {
//            return
//                (!Core.Hotbar.ActivePowers.Contains(snoPower) || (Core.Hotbar.ActivePowers.Contains(snoPower) && GetHasBuff(snoPower)));
//        }
...
//        {
//            return Core.Hotbar.GetSkillCharges(power);
//        }
...
//            return Legendary.ConventionOfElements.IsEquipped && Core.Buffs.ConventionElement != skill.Element;
//        }
...
//            get
//            {
//                if (Sets.BastionsOfWill.IsFullyEquipped && !Core.Buffs.HasBastiansWillGeneratorBuff)
//                    return true;
...
//            get
//            {
//                if (Sets.BastionsOfWill.IsFullyEquipped && !Core.Buffs.HasBastiansWillSpenderBuff)
//                    return true;
...
//                typeName, power.SNOPower, (int)power.SNOPower, (Combat.Targeting.CurrentTarget == null) ? "None" : Combat.Targeting.CurrentTarget.InternalName);
...
//                    if (meta.IsCombatOnly && Combat.Targeting.CurrentTarget == null)
//                        return "IsInCombat";
...
//        {
//            get { return Core.Hotbar.ActiveSkills.All(s => s.Skill.IsGeneratorOrPrimary); }
//        }
...
//            {
//                Logger.Log(LogCategory.Targetting, "Calculating TargetPosition for {0} as Self. Combat.Targeting.CurrentTarget={1}", skill.Name, Combat.Targeting.CurrentTarget != null ? Combat.Targeting.CurrentTarget.InternalName : "");
...
//                {
//                    Logger.Log(LogCategory.Targetting, "Calculating TargetPosition for {0} using TargetPositionSelector at {1} Dist={2} PlayerIsFacing(CastPosition={3} Combat.Targeting.CurrentTarget={4}) Combat.Targeting.CurrentTarget={5}",
//                        skill.Name,
//                        targetPosition,
//                        Player.Position.Distance(targetPosition),
//                        Player.IsFacing(targetPosition),
//                        Player.IsFacing(Combat.Targeting.CurrentTarget.Position),
//                        Combat.Targeting.CurrentTarget != null ? Combat.Targeting.CurrentTarget.InternalName : "Null"
//                        );
...
//                if (targetUnit != null)
//                {
//                    Logger.Log(LogCategory.Targetting, "Calculating TargetPosition for {0} using TargetUnitSelector at {1} Dist={2} Combat.Targeting.CurrentTarget={3}",
//                        skill.Name,
//                        targetUnit.Position,
...
//                Logger.Log(LogCategory.Targetting, "Calculating TargetPosition for {0} using AreaEffectTargetting at {1} Dist={2} PlayerIsFacing(CastPosition={3} Combat.Targeting.CurrentTarget={4}) Combat.Targeting.CurrentTarget={5} AreaShape={6} AreaRadius={7} ",
//                    skill.Name,
//                    target,
...
//            return skill.ToPower(castRange, Combat.Targeting.CurrentTarget.Position);
//        }
...
//        public static bool IsInCombat => Combat.Targeting.CurrentTarget != null && Combat.Targeting.CurrentTarget.ActorType == ActorType.Monster;
...
//        public static Func<bool> IsKitingDisabled = () => false;
...
//                if (!Core.Avoidance.Grid.CanRayWalk(Combat.Targeting.CurrentTarget.Position, buffedLocation))
//                    return false;
