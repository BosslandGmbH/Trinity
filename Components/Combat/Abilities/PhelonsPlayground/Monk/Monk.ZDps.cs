...
//            private static TrinityPower Walk(float maxRange, bool objectsInAoe) => new TrinityPower(SNOPower.Walk, 0f, TargetUtil.BestTankPosition(maxRange, objectsInAoe));
...
//                if (!Skills.Monk.DashingStrike.CanCast() || charges < 1)
//                    return false;
...
//                    (charges > 1 && Core.Player.PrimaryResource >= 75 ||
//                     Core.Buffs.HasCastingShrine))
//                    return true;

//                if (!Sets.ThousandStorms.IsSecondBonusActive &&
//                    (TargetUtil.AnyMobsInRange(60f) || Core.Buffs.HasCastingShrine))
//                    return true;
//                return false;
//            }
...
//                           TargetUtil.BestAoeUnit(45, true).Distance < 20;
//                }
//            }
