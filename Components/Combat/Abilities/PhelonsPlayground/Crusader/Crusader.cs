...
//        public static bool IsSteedCharging => DataDictionary.SteedChargeAnimations.Contains(Player.CurrentAnimation);
...
//            {
//                if (IsBombardment)
//                    return LegacyOfNightmares.PowerSelector();// ?? new TrinityPower(SNOPower.Walk, 5f, TargetUtil.BestWalkLocation);
//            }
//            return power;
//        }
//    }
