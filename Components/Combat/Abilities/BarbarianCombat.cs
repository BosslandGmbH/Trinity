...
namespace Trinity.Components.Combat.Abilities
{
    class BarbarianCombat : CombatBase
    {
        ...
        public static bool CanUseRend
        {
            get
            {
                ...
                var mobCountThreshold =
                    Trinity.TrinityPlugin.Targets.Count(
            ...
            get
            {
                ...
                return CurrentTarget.RadiusDistance <= 10 && !overPowerHasBuffEffect &&
                       ...
                       (CurrentTarget.IsElite || CurrentTarget.IsMinion || CurrentTarget.IsBoss ||
                        TargetUtil.NumMobsInRangeOfPosition(Core.Player.Position, 9) >= 4);
            }
        }
        ...
        public static bool CanUseSprint
        {
            get
            {
                if (Core.Settings.Combat.Barbarian.SprintMode != BarbarianSprintMode.MovementOnly &&
        ...
        public static bool CanUseAvalanche
        {
            ...
            {
                bool hasBerserker =
                    Core.Hotbar.PassiveSkills.Any(p => p == SNOPower.Barbarian_Passive_BerserkerRage);
        ...
        public static TrinityPower PowerWhirlwind
        {
            get
            {
                return new TrinityPower(SNOPower.Barbarian_Whirlwind, 20f,
                    TargetUtil.GetZigZagTarget(CurrentTarget.Position, 20), Trinity.TrinityPlugin.CurrentWorldDynamicId, -1, 0,
                    1);
            }
        }
