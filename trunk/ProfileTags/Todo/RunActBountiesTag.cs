...
//            {
//                Core.Logger.Error("[RunActBounties] Invalid act, valid acts are {0}", string.Join(", ", ValidActs));
//                _isDone = true;
//            }
...
//            {
//                Core.Logger.Debug("[RunActBountiesTag] Sleeping 1 second due to world change");
