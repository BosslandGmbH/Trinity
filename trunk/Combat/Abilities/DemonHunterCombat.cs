    ...
    public class DemonHunterCombat : CombatBase
    {
        ...
        public static bool IsVaultFree
        {
            get
            {
                ...
                if (CacheData.Buffs.HasBuff(445266)) //'P4_ItemPassive_Unique_Ring_006' (445266)
                    return true;
        ...
        private static bool FanOfKnivesCondition(SkillMeta meta)
        {
            ...
            if (IsUsingShadowFanBuild)
            {
                ...
                var stacks = CacheData.Buffs.GetBuffStacks(445274);
                ...
                if (Legendary.ConventionOfElements.IsEquipped && CacheData.Buffs.ConventionElement != meta.Skill.Element)
                    return false;
