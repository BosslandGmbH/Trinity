...
namespace Trinity.Reference
{
    public static class Runes
    {
        ...
        // AUTO-GENERATED on Fri, 29 Apr 2016 04:42:54 GMT
        ...
        public class Monk : FieldCollection<Monk, Rune>
        {
            ...
            public static Rune CripplingLight = new Rune
            {
                ...
                Description = "Enemies that are Blinded deal 40% reduced damage for 5 seconds after the Blind wears off.",
            ...
            /// <summary>
            /// Imbue yourself with water, causing your abilities to heal yourself and allies within 30 yards for 40232 Life.Heal amount is increased by 10% of your Health Globe Healing Bonus.
            /// </summary>
            public static Rune SoothingMist = new Rune
            {
                Index = 3,
                Name = "Soothing Mist",
                Description = "Imbue yourself with water, causing your abilities to heal yourself and allies within 30 yards for 40232 Life.Heal amount is increased by 10% of your Health Globe Healing Bonus.",
        ...
        public class DemonHunter : FieldCollection<DemonHunter, Rune>
        {
            ...
            /// <summary>
            /// Increase to 575% weapon damage as Cold.The trap explodes in a single blast that freezes any targets hit for 3 seconds. Whilst frozen damage is amplified by 20%.
            /// </summary>
            public static Rune EchoingBlast = new Rune
            {
                Index = 1,
                Name = "Echoing Blast",
                Description = "Increase to 575% weapon damage as Cold.The trap explodes in a single blast that freezes any targets hit for 3 seconds. Whilst frozen damage is amplified by 20%.",
            ...
            /// <summary>
            /// Plant the bomb on a single targeted enemy.After 1 second the bomb explodes dealing 915% weapon damage to all enemies within 12 yards.
            /// </summary>
            public static Rune StickyTrap = new Rune
            {
                Index = 2,
                Name = "Sticky Trap",
                Description = "Plant the bomb on a single targeted enemy.After 1 second the bomb explodes dealing 915% weapon damage to all enemies within 12 yards.",
            ...
            /// <summary>
            /// Increases arming time to 3 seconds but increases damage to 930% weapon damage in a single blast.Enemies hit are stunned for 2 seconds.
            /// </summary>
            public static Rune LongFuse = new Rune
            {
                Index = 3,
                Name = "Long Fuse",
                Description = "Increases arming time to 3 seconds but increases damage to 930% weapon damage in a single blast.Enemies hit are stunned for 2 seconds.",
            ...
            /// <summary>
            /// When triggered lightning chain hits up to 3 enemies within 10 yards.Lightning will also arc from any triggered trap to any armed traps within 75 yards.All enemies are hit for 880% weapon damage as Lightning over 10 hits.
            /// </summary>
            public static Rune LightningRod = new Rune
            {
                Index = 4,
                Name = "Lightning Rod",
                Description = "When triggered lightning chain hits up to 3 enemies within 10 yards.Lightning will also arc from any triggered trap to any armed traps within 75 yards.All enemies are hit for 880% weapon damage as Lightning over 10 hits.",
            ...
            /// <summary>
            /// Enemies hit are Chilled and have 15% increased chance to be Critically Hit for 3 seconds.
            /// </summary>
            public static Rune WindChill = new Rune
            {
                Index = 2,
                Name = "Wind Chill",
                Description = "Enemies hit are Chilled and have 15% increased chance to be Critically Hit for 3 seconds.",
        ...
        public class WitchDoctor : FieldCollection<WitchDoctor, Rune>
        {
            ...
            public static Rune ChilledToTheBone = new Rune
            {
                ...
                Description = "Enemies who hit or are hit by your Zombie Dogs are Chilled for 3 seconds and take 15% increased damage from all sources.",
            ...
            /// <summary>
            /// Haunted enemies take 20% more damage from all sources.Haunt&#39;s damage turns into Poison.
            /// </summary>
            public static Rune PoisonedSpirit = new Rune
            {
                Index = 4,
                Name = "Poisoned Spirit",
                Description = "Haunted enemies take 20% more damage from all sources.Haunt&#39;s damage turns into Poison.",
            ...
            public static Rune Jinx = new Rune
            {
                Index = 2,
                Name = "Jinx",
                Description = "Increases the magnitude of the hex to 30% additional damage.",
                Tooltip = "rune/hex/e",
                TypeId = "e",
                RuneIndex = 4,
                SkillIndex = 16,
            ...
            /// <summary>
            /// Summon a giant toad that pulls in enemies, briefly swallows them whole, then spits them back out with a layer of goo that deals 750% weapon damage as Poison over 5 seconds, Slows them, and increases their damage taken by 25%.
            /// </summary>
            public static Rune ToadOfHugeness = new Rune
            {
                Index = 4,
                Name = "Toad of Hugeness",
                Description = "Summon a giant toad that pulls in enemies, briefly swallows them whole, then spits them back out with a layer of goo that deals 750% weapon damage as Poison over 5 seconds, Slows them, and increases their damage taken by 25%.",
                Tooltip = "rune/hex/a",
                TypeId = "a",
                RuneIndex = 0,
                SkillIndex = 16,
            ...
            /// <summary>
            /// All enemies in the area of Mass Confusion take 30% additional damage for 12 seconds.
            /// </summary>
            public static Rune Paranoia = new Rune
            {
                Index = 4,
                Name = "Paranoia",
                Description = "All enemies in the area of Mass Confusion take 30% additional damage for 12 seconds.",
