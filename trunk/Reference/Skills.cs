...
namespace Trinity.Reference
{
    public static class Skills
    {
        ...
        public class WitchDoctor : FieldCollection<WitchDoctor, Skill>
        {
            ...
            /// <summary>
            /// Cooldown: 15 secondsSummon a Fetish Shaman for 12 seconds that will hex groups of enemies into chickens. Hexed enemies are unable to perform offensive actions and take 15% additional damage.
            /// </summary>
            public static Skill Hex = new Skill
            {
                ...
                RequiredLevel = 22,
                Description = "Cooldown: 15 secondsSummon a Fetish Shaman for 12 seconds that will hex groups of enemies into chickens. Hexed enemies are unable to perform offensive actions and take 15% additional damage.",
            ...
            /// <summary>
            /// Cooldown: 120 secondsConjure a Fetish that begins a ritual dance that increases the attack speed and movement speed of all nearby allies by 20% for 20 seconds.
            /// </summary>
            public static Skill BigBadVoodoo = new Skill
            {
                ...
                RequiredLevel = 25,
                Description = "Cooldown: 120 secondsConjure a Fetish that begins a ritual dance that increases the attack speed and movement speed of all nearby allies by 20% for 20 seconds.",
        ...
        public class DemonHunter : FieldCollection<DemonHunter, Skill>
        {
            ...
            /// <summary>
            /// Cost: 30 HatredLay a trap that arms after 1.5 seconds and triggers when an enemy approaches. The trap has a 0.5 second re-arming time and can explode up to 3 times, each time dealing 340% weapon damage as Fire to all enemies within 8 yards.You can have a maximum of 3 Spike Traps active at one time.
            /// </summary>
            public static Skill SpikeTrap = new Skill
            {
                ...
                RequiredLevel = 17,
                Description = "Cost: 30 HatredLay a trap that arms after 1.5 seconds and triggers when an enemy approaches. The trap has a 0.5 second re-arming time and can explode up to 3 times, each time dealing 340% weapon damage as Fire to all enemies within 8 yards.You can have a maximum of 3 Spike Traps active at one time.",
            ...
            /// <summary>
            /// Cost: 3 DisciplineMark an enemy. The marked enemy takes 20% additional damage for the next 30 seconds.
            /// </summary>
            public static Skill MarkedForDeath = new Skill
            {
                ...
                RequiredLevel = 21,
                Description = "Cost: 3 DisciplineMark an enemy. The marked enemy takes 20% additional damage for the next 30 seconds.",
        ...
        public class Monk : FieldCollection<Monk, Skill>
        {
            ...
            /// <summary>
            /// Cost: 50 SpiritActive: Damage bonus is increased to 20% for 3 seconds.Passive: Enemies within 30 yards of you take 10% increased damage.Only one Mantra may be active at a time.
            /// </summary>
            public static Skill MantraOfConviction = new Skill
            {
                ...
                RequiredLevel = 30,
                Description = "Cost: 50 SpiritActive: Damage bonus is increased to 20% for 3 seconds.Passive: Enemies within 30 yards of you take 10% increased damage.Only one Mantra may be active at a time.",
