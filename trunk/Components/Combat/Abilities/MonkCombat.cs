    ...
    public class MonkCombat : CombatBase
    {
        ...
        public static TrinityPower GetPower()
        {
            ...
            if (!Player.IsIncapacitated && (Player.CurrentHealthPct <= 0.65 || Player.IsFrozen) 
                ...
                !Core.Buffs.HasBuff(SNOPower.X1_Monk_MantraOfEvasion_v2_Passive, 1) && Settings.Combat.Monk.DisableMantraSpam)
            ...
            if (CanRecastTempestRush())
            {
                ...
                return new TrinityPower(SNOPower.Monk_TempestRush, 23f, ZigZagPosition, Trinity.TrinityPlugin.CurrentWorldDynamicId, -1, 0, 0);
            }
        ...
        internal static bool ShouldSpreadWotHF()
        {
            ...
            // Only spread if less than the settings % of monsters have debuff.
            TargetUtil.PercentOfMobsDebuffed(SNOPower.Monk_WayOfTheHundredFists, 10f) <= mobPct;            
        ...
        private static bool CanCastDashingStrike
        {
            get
            {
                ...
                if (IsCurrentlyAvoiding ||
                    TimeSincePowerUse(SNOPower.X1_Monk_DashingStrike) < Settings.Combat.Monk.DashingStrikeDelay ||
                    CombatManager.TargetHandler.ShouldWaitForLootDrop || charges < 1 || !CanCast(SNOPower.X1_Monk_DashingStrike))
                    return false;
        ...
        internal static TrinityPower JawBreakerDashingStrike()
        {
            ...
            if (Skills.Monk.DashingStrike.Charges > 1 && TargetUtil.AnyMobsInRange(25f, 3) || TargetUtil.IsEliteTargetInRange(70f)) // surround by mobs or elite engaged.
            {
                ...
                {
                    return new TrinityPower(SNOPower.X1_Monk_DashingStrike, MaxDashingStrikeRange, farthestTarget.Position, Trinity.TrinityPlugin.CurrentWorldDynamicId, -1, 2, 2);
                }
                ...
                return new TrinityPower(SNOPower.X1_Monk_DashingStrike, MaxDashingStrikeRange, bestClusterPoint, Trinity.TrinityPlugin.CurrentWorldDynamicId, -1, 2, 2);
            }
            ...
            if (Skills.Monk.DashingStrike.Charges > 1 && TargetUtil.ClusterExists(20, 50, 3))
            {
                ...
                {
                    return new TrinityPower(SNOPower.X1_Monk_DashingStrike, MaxDashingStrikeRange, dashStrikeBestClusterPoint, Trinity.TrinityPlugin.CurrentWorldDynamicId, -1, 2, 2);
                }
            }
            ...
            return new TrinityPower(SNOPower.X1_Monk_DashingStrike, MaxDashingStrikeRange, CurrentTarget.Position, Trinity.TrinityPlugin.CurrentWorldDynamicId, -1, 2, 2);
        }
