...
//            if (IsFirebirdArchonBuild && TryGetFirebirdArchonPower(out power))
//                return power;
...
//        private static bool TryGetFirebirdArchonPower(out TrinityPower power)
//        {
//            power = null;
...
//            {
//                // Spam blast constantly
//                if (Skills.Wizard.ArchonBlast.CanCast())
//                    Skills.Wizard.ArchonBlast.Cast();
...
//                    {
//                        Logger.Warn("strike on target");
//                        Skills.Wizard.ArchonBlast.Cast(CurrentTarget.Position);
//                    }

//                    // Teleport onto clusters
//                    if (Skills.Wizard.ArchonTeleport.CanCast())
//                    {
//                        Logger.Warn("teleport on target");
//                        Skills.Wizard.ArchonBlast.Cast(CurrentTarget.Position);
//                    }
//                }
//            }
                            
//            // Teleport every 5s for safe passage armor buff
//            if (Skills.Wizard.Teleport.CanCast() && Skills.Wizard.Teleport.TimeSinceUse > 4000 && !Core.Buffs.HasBuff(SNOPower.Wizard_Archon_Teleport))
//            {
//                power = new TrinityPower(SNOPower.Wizard_Teleport, 50f, CurrentTarget?.Position ?? Player.Position);
//                return true;
//            }
...
//                    if (!blackHoleExists)
//                    {
//                        return new TrinityPower(SNOPower.X1_Wizard_Wormhole, 65f, TargetUtil.GetBestClusterUnit(blackholeRadius, 45f,  false).Position);
//                    }
//                }
//                else
//                {
...
//                {
//                    if (Core.Clusters.LargeCluster.Exists && Core.Clusters.LargeCluster.Position.Distance(myPosition) < bubbleMaxRange && isValidBubblePosition(Core.Clusters.LargeCluster.Position))
//                    {
//                        reason = "Bubble on big cluster (DMO)";
//                        bubblePower = new TrinityPower(SNOPower.Wizard_SlowTime, bubbleMaxRange, Core.Clusters.LargeCluster.Position);
//                    }
...
//                return new TrinityPower(SNOPower.Wizard_Disintegrate, disintegrateRange, Vector3.Zero, CurrentTarget.AcdId, 0, 0);
//            }
...
//        /// </summary>
//        /// <returns></returns>
//        public static TrinityPower GetBuffPower()
//        {
...
//            TargetUtil.DebuffedPercent(SNOPower.ItemPassive_Unique_Ring_733_x1, 60f) < 1;
//        }
...
//            // Arcane Blast
//            if (!IsFirebirdArchonBuild && !Settings.Combat.Wizard.NoArcaneBlast && TargetUtil.AnyMobsInRange(15f) && beam != null && PowerManager.CanCast(blast.Power))
//            {
