...
//                {
//                    return TargetUtil.GetTwisterDiaObjects(25, true)
//                        .OrderBy(x => x.Position.Distance(TargetUtil.BestAoeUnit(45, true).Position))
//                        .FirstOrDefault(
//                            x => x.Position.Distance(TargetUtil.BestAoeUnit(45, true).Position) < 7 && x.CanCastTo());
//                }
...
//                        if (TargetUtil.BestAoeUnit(45, true) == null) return Vector3.Zero;
//                        var distance = TargetUtil.BestAoeUnit(45, true).Distance - 5;
//                        return MathEx.CalculatePointFrom(Player.Position, TargetUtil.BestAoeUnit(45, true).Position,
//                            distance);
//                    }
//                }
...
//                    => Skills.Wizard.BlackHole.CanCast() && TargetUtil.BestAoeUnit(45, true).Distance < 45;
...
//                    => new TrinityPower(Skills.Wizard.BlackHole.SNOPower, 45, TargetUtil.BestAoeUnit(45, true).Position);
