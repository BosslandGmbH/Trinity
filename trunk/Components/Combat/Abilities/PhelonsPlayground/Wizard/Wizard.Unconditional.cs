...
//            public static bool CanTeleport => Skills.Wizard.Teleport.CanCast() || Skills.Wizard.ArchonTeleport.CanCast();
...
//                if (Core.Player.CurrentHealthPct < Settings.Combat.Wizard.HealthGlobeLevel)
//                {
...
//                    position = TargetUtil.BestAoeUnit(45f, true).Position;
//                    return true;
//                }
//                var maxRange = DMOCount > 2 || GetHasBuff(Skills.Wizard.Archon.SNOPower) || IsInParty ? 14 : 40;

//                var bestDpsPosition = IsInParty && TargetUtil.Monk != null
//                        ? TargetUtil.Monk.Position
//                        : TargetUtil.BestDpsPosition(TargetUtil.BestTarget(45f, true).Position, maxRange, true);
