...
//                        if (TargetUtil.BestBuffPosition(35f, bestDpsTarget.Position, true, out bestDpsPosition) && bestDpsPosition.Distance2D(Player.Position) > 6f)
//                        {
...
//                    target = TargetUtil.BestAuraUnit(SNOPower.Witchdoctor_Haunt, 55f, true);
