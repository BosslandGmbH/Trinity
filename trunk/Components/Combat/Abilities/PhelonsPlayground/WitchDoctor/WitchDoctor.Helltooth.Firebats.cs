...
//                    var bestDpsTarget = TargetUtil.BestAoeUnit(25f, true);
...
//                        {
//                            Logger.LogNormal("Moving to GLOBE Location - Spirit Walk " + TargetUtil.ClosestGlobe(35f, true).Position.Distance2D(Player.Position));
//                            return new TrinityPower(SNOPower.Walk, 3f, TargetUtil.ClosestGlobe(35f, true).Position);
//                        }

//                        if (TargetUtil.BestBuffPosition(12f, bestDpsTarget.Position, true, out bestDpsPosition) && bestDpsPosition.Distance2D(Player.Position) > 6f)
//                        {
...
//                    return TargetUtil.BestAoeUnit(45f, true).Distance < 10f;
//                }
...
//                    if ((double)TargetUtil.AuraUnits(Skills.WitchDoctor.LocustSwarm.SNOPower).Count /
//                        TargetUtil.SafeList(true).Count(x => x.Distance <= 12f) > 0.80)
//                        return false;

//                    target = TargetUtil.BestAuraUnit(SNOPower.Witchdoctor_Haunt, 15f, true);
...
//                    target = TargetUtil.BestAoeUnit(55f, true);
//                    if (target != null)
//                        return true;
...
//                        : TargetUtil.BestAoeUnit(55f, true);
...
//                        return false;
//                    if ((double) TargetUtil.AuraUnits(Skills.WitchDoctor.Haunt.SNOPower).Count/
//                        TargetUtil.SafeList(true).Count(x => x.Distance <= 12f) > 0.80)
//                        return false;
//                    target = TargetUtil.BestAuraUnit(SNOPower.Witchdoctor_Haunt, 15f, true);
