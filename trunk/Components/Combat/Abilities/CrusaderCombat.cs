...
//        {
//            get { return Core.Settings.Combat.Crusader; }
//        }
...
//            {
//                // LawsOfJustice
//                if (CanCast(SNOPower.X1_Crusader_LawsOfJustice2) && !Core.Buffs.HasBuff(SNOPower.X1_Crusader_LawsOfJustice2, 6) &&
...
//                if (Core.Buffs.ConventionElement == Element.Fire && Legendary.ConventionOfElements.IsEquipped)
//                {
...
//                // LawsOfJustice
//                if (CanCast(SNOPower.X1_Crusader_LawsOfJustice2) && !Core.Buffs.HasBuff(SNOPower.X1_Crusader_LawsOfJustice_Passive2, 6) &&
//                    (TargetUtil.EliteOrTrashInRange(16f) ||
//                     Player.CurrentHealthPct <= CrusaderSettings.LawsOfJusticeHpPct ||
...
//            if (!ZetaDia.IsInTown && Settings.Combat.Crusader.AlignTroveBombardment && Core.Buffs.ConventionElement == Element.Holy)
//            {
...
//            IsKitingDisabled = () => TargetUtil.AnyElitesInRange(100f) && IsBombardmentWindow();
...
//                {
//                    Logger.Log($"IronSkin without Target {Player.CurrentHealthPct} {CrusaderSettings.IronSkinHpPct} {Core.Buffs.ConventionElement} {Core.Buffs.ConventionElementElapsedMs}");
//                    return new TrinityPower(SNOPower.X1_Crusader_IronSkin);
//                }
...
//                // LawsOfHope
//                if (CanCast(SNOPower.X1_Crusader_LawsOfHope2) && !Core.Buffs.HasBuff(SNOPower.X1_Crusader_LawsOfHope2, 6) &&
...
//                    (TargetUtil.EliteOrTrashInRange(16f) ||
//                     TargetUtil.AnyMobsInRange(15f, 5) || Settings.Combat.Crusader.SpamLaws) &&
//                    !Core.Buffs.HasBuff(SNOPower.X1_Crusader_LawsOfHope_Passive2, 6))
//                {
//                    return new TrinityPower(SNOPower.X1_Crusader_LawsOfHope2);
//                }
...
//                    !Core.Buffs.HasBuff(SNOPower.X1_Crusader_LawsOfValor_Passive2, 6) &&
...
//                    return new TrinityPower(SNOPower.Walk, 20f, TargetUtil.GetZigZagTarget(CurrentTarget.Position, 35f, true), -1, 0, 1);
//                }
//            }
...
//                    !Core.Buffs.HasBuff(SNOPower.X1_Crusader_LawsOfJustice2, 6) &&
//                    (Player.CurrentHealthPct <= CrusaderSettings.LawsOfJusticeHpPct))
//                {
//                    return new TrinityPower(SNOPower.X1_Crusader_LawsOfJustice2);
//                }
...
//                    !Core.Buffs.HasBuff(SNOPower.X1_Crusader_LawsOfValor2, 6) &&
//                    !IsSteedCharging)
//                {
//                    return new TrinityPower(SNOPower.X1_Crusader_LawsOfValor2);
//                }
...
//                // LawsOfValor
//                // LawsOfValor2
//                if (CanCast(SNOPower.X1_Crusader_LawsOfValor2) && !Core.Buffs.HasBuff(SNOPower.X1_Crusader_LawsOfValor_Passive2, 6) &&
...
//                bool hasPiercingShield = Core.Hotbar.ActiveSkills.Any(s => s.Power == SNOPower.X1_Crusader_BlessedShield && s.RuneIndex == 5);
...
//                {
//                    var bestTarget = CurrentTarget.IsBoss ? CurrentTarget : TargetUtil.GetBestClusterUnit(15, 50f, true, false);
//                    if (bestTarget != null)
...
//                // LawsOfValor2
//                if (CanCast(SNOPower.X1_Crusader_LawsOfValor2) && TargetUtil.EliteOrTrashInRange(16f) && !Core.Buffs.HasBuff(SNOPower.X1_Crusader_LawsOfValor2, 6))
//                {
//                    return new TrinityPower(SNOPower.X1_Crusader_LawsOfValor2);
//                }
//            }
...
//                (Core.Buffs.ConventionElement != Element.Holy || Player.CurrentHealthPct <= 0.5))
//                return true;
