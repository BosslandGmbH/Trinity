...
namespace Trinity.Settings.Combat
{
    public interface IAvoidanceHealth
    {
        ...
        float AvoidButcherFloorPanelHealth { get; set; }
        ...
        float AvoidIceTrailHealth { get; set; }
        float AvoidOrbiterHealth { get; set; }
        float AvoidMageFireHealth { get; set; }
        float AvoidMaghdaProjectilleHealth { get; set; }
        float AvoidMoltenBallHealth { get; set; }
