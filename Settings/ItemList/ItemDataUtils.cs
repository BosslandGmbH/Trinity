...
namespace Trinity.Settings.ItemList
{
    ...
    public class ItemDataUtils
    {
        ...
        public static readonly Dictionary<SNOActor, ItemPowerDescripter> ItemPassivePowers = new Dictionary<SNOActor, ItemPowerDescripter>
        {
            { SNOActor.healthPotion_Legendary_07_p2, new ItemPowerDescripter(433021, 1773655297, 20, 30, true) }, // Bottomless Potion of Rejuvenation (P2_Legendary_Potion_07) Restores 20–30% resource when used below 50% health.
            { SNOActor.Amulet_norm_unique_03, new ItemPowerDescripter(364343, 1492350209, 240, 320, true) }, // Moonlight Ward (itemPassive_Unique_Amulet_003_x1) Hitting an enemy within 15 yards has a chance to ward you with shards of Arcane energy that explode when enemies get close, dealing 240–320% weapon damage as Arcane to enemies within 15 yards.
            { SNOActor.BarbBelt_norm_unique_08, new ItemPowerDescripter(423235, 1733571841, 6, 8, false) }, // Belt of the Trove (P2_ItemPassive_Unique_Ring_011) Every 6–8 seconds, call down Bombardment on a random nearby enemy.
            { SNOActor.chestArmor_norm_unique_074, new ItemPowerDescripter(446615, 1829336321, 250, 300, true) }, // Heart of Iron (446615) Gain Thorns equal to 250–300% of your Vitality.
            { SNOActor.x1_flail2H_norm_unique_04, new ItemPowerDescripter(359546, 1472701697, 4, 6, false) }, // Golden Flense (ItemPassive_Unique_Ring_705_x1) Sweep Attack restores 4–6 Wrath for each enemy hit.
            { SNOActor.Amulet_norm_unique_06, new ItemPowerDescripter(318716, 1305462017, 10, 15, true) }, // The Star of Azkaranth (ItemPassive_Unique_Ring_545_x1) Prevent all Fire damage taken and heal yourself for 10–15% of the amount prevented.
            { SNOActor.mightyWeapon_2H_norm_unique_01, new ItemPowerDescripter(435040, 1781925121, 20, 25, false) }, // The Gavel of Judgment (P2_ItemPassive_Unique_Ring_059) Hammer of the Ancients returns 20–25 Fury if it hits 3 or fewer enemies.
            { SNOActor.Bracers_norm_unique_07, new ItemPowerDescripter(318772, 1305691393, 20, 30, true) }, // Strongarm Bracers (ItemPassive_Unique_Ring_590_x1) Enemies hit by knockbacks suffer 20–30% increased damage for 5 seconds when they land.
            { SNOActor.Ring_norm_unique_004, new ItemPowerDescripter(318375, 1304065281, 12, 16, false) }, // Puzzle Ring (ItemPassive_Unique_Ring_513_x1) Summon a treasure goblin who picks up normal-quality items for you. After picking up 12–16 items, he drops a rare item with a chance for a legendary.
            { SNOActor.x1_Belt_norm_unique_19, new ItemPowerDescripter(318881, 1306137857, 100, 135, true) }, // Harrington Waistguard (ItemPassive_Unique_Ring_685_x1) Opening a chest grants 100–135% increased damage for 10 seconds.
            { SNOActor.pants_norm_unique_077, new ItemPowerDescripter(446502, 1828873473, 300, 400, true) }, // Hammer Jammers (446502) Enemies take 300–400% increased damage from your Blessed Hammers for 10 seconds after you hit them with a Blind, Immobilize, or Stun.
            { SNOActor.p4_Bracers_norm_unique_04, new ItemPowerDescripter(446162, 1827480833, 150, 200, true) }, // Bracer of Fury (446162) Heaven's Fury deals 150–200% increased damage to enemies that are Blinded, Immobilized, or Stunned.
            { SNOActor.Shield_norm_unique_01, new ItemPowerDescripter(318816, 1305871617, 0.5, 1.5, false) }, // Freeze of Deflection (ItemPassive_Unique_Ring_634_x1) Blocking an attack has a chance to Freeze the attacker for 0.5–1.5 seconds.
            { SNOActor.pants_norm_unique_044, new ItemPowerDescripter(402416, 1648297217, 80, 100, true) }, // Depth Diggers (ItemPassive_Unique_Ring_908_x1) Primary skills that generate resource deal 80–100% additional damage.
            { SNOActor.pants_norm_unique_048, new ItemPowerDescripter(434009, 1777702145, 450, 550, true) }, // Pox Faulds (itemPassive_Unique_Pants_007_p2) When 3 or more enemies are within 12 yards, you release a vile stench that deals 450–550% weapon damage as Poison every second for 5 seconds to enemies within 15 yards.
            { SNOActor.x1_Shield_norm_unique_14, new ItemPowerDescripter(446142, 1827398913, 15, 20, true) }, // Shield of Fury (446142) Each time an enemy takes damage from your Heaven's Fury, it increases the damage they take from your Heaven&#39;s Fury by 15–20%.
            { SNOActor.x1_Gloves_norm_unique_01, new ItemPowerDescripter(434007, 1777693953, 120, 150, true) }, // St. Archew's Gage (ItemPassive_Unique_Ring_664_p2) The first time an elite pack damages you, gain an absorb shield equal to 120–150% of your maximum Life for 10 seconds.
            { SNOActor.Mace_norm_unique_08, new ItemPowerDescripter(364325, 1492276481, 20, 40, true) }, // Odyn Son (itemPassive_Unique_Mace_1H_002_x1) 20–40% chance to Chain Lightning enemies when you hit them.
            { SNOActor.x1_flail1H_norm_unique_04, new ItemPowerDescripter(359538, 1472668929, 15, 20, true) }, // Kassar's Retribution (ItemPassive_Unique_Ring_701_x1) Casting Justice increases your movement speed by 15–20% for 2 seconds.
            { SNOActor.healthPotion_Legendary_09_x1, new ItemPowerDescripter(434626, 1780229377, 20, 25, true) }, // Bottomless Potion of Amplification (X1_Legendary_Potion_09) Increases healing from all sources by 20–25% for 5 seconds.
            { SNOActor.x1_Axe_norm_unique_09, new ItemPowerDescripter(318869, 1306088705, 75, 100, true) }, // Hack (ItemPassive_Unique_Ring_673_x1) 75–100% of your Thorns damage is applied on every attack.
            { SNOActor.Belt_norm_unique_06, new ItemPowerDescripter(446541, 1829033217, 25, 30, true) }, // String of Ears (446541) Reduces damage from melee attacks by 25–30%.
            { SNOActor.p4_Bracers_norm_unique_03, new ItemPowerDescripter(446008, 1826850049, 400, 500, true) }, // Akkhan’s Manacles (446008) Blessed Shield damage is increased by 400–500% for the first enemy it hits.
            { SNOActor.Amulet_norm_unique_13, new ItemPowerDescripter(318719, 1305474305, 10, 15, true) }, // Mara's Kaleidoscope (ItemPassive_Unique_Ring_548_x1) Prevent all Poison damage taken and heal yourself for 10–15% of the amount prevented.
            { SNOActor.x1_CruShield_norm_unique_04, new ItemPowerDescripter(318888, 1306166529, 20, 25, true) }, // Akarat's Awakening (ItemPassive_Unique_Ring_692_x1) Every successful block has a 20–25% chance to reduce all cooldowns by 1 second.
            { SNOActor.BarbBelt_norm_unique_03, new ItemPowerDescripter(364341, 1492342017, 100, 130, true) }, // Thundergod's Vigor (ItemPassive_Unique_BarbBelt_003_x1) Blocking, dodging or being hit causes you to discharge bolts of electricity that deal 100–130% weapon damage as Lightning.
            { SNOActor.p2_Ring_norm_unique_03, new ItemPowerDescripter(430674, 1764041985, 150, 200, true) }, // Convention of Elements (P2_ItemPassive_Unique_Ring_038) Gain 150–200% increased damage to a single element for 4 seconds. This effect rotates through the elements available to your class in the following order: Arcane, Cold, Fire, Holy, Lightning, Physical, Poison.
            { SNOActor.p3_Bracers_norm_unique_06, new ItemPowerDescripter(440790, 1805477121, 60000, 80000, false) }, // Coils of the First Spider (P3_ItemPassive_Unique_Ring_029) While channeling Firebats, you gain 30% damage reduction and 60000–80000 Life per Hit.
            { SNOActor.Mojo_norm_unique_01, new ItemPowerDescripter(318721, 1305482497, 25, 30, true) }, // Uhkapian Serpent (ItemPassive_Unique_Ring_550_x1) 25–30% of the damage you take is redirected to your Zombie Dogs.
            { SNOActor.x1_voodooMask_norm_unique_08, new ItemPowerDescripter(318411, 1304212737, 75, 100, true) }, // Mask of Jeram (ItemPassive_Unique_Ring_526_x1) Pets deal 75–100% increased damage.
            { SNOActor.p3_Belt_norm_unique_04, new ItemPowerDescripter(445427, 1824470273, 9, 12, false) }, // The Shame of Delsere (445427) Your Signature Spells attack 50% faster and restore 9–12 Arcane Power.
            { SNOActor.Boots_norm_set_01, new ItemPowerDescripter(451186, 1848059137, 275, 350, true) }, // Nilfur's Boast (451186) Increase the damage of Meteor by 200%. When your Meteor hits 3 or fewer enemies, the damage is increased by 275–350%.
            { SNOActor.fistWeapon_norm_unique_06, new ItemPowerDescripter(318433, 1304302849, 250, 300, true) }, // The Fist of Az'Turrasq (ItemPassive_Unique_Ring_540_x1) Exploding Palm's on-death explosion damage is increased by 250–300%.
            { SNOActor.x1_Bracers_norm_unique_12, new ItemPowerDescripter(318770, 1305683201, 9, 12, true) }, // Ancient Parthan Defenders (ItemPassive_Unique_Ring_588_x1) Each stunned enemy within 25 yards reduces your damage taken by 9–12%.
            { SNOActor.Wand_norm_unique_02, new ItemPowerDescripter(450472, 1845134593, 150, 200, true) }, // Fragment of Destiny (450472) Spectral Blade attacks 50% faster and deals 150–200% increased damage.
            { SNOActor.x1_CruShield_norm_unique_03, new ItemPowerDescripter(318887, 1306162433, 45, 60, true) }, // Hallowed Bulwark (ItemPassive_Unique_Ring_691_x1) Iron Skin also increases your Block Amount by 45–60%.
            { SNOActor.x1_mightyWeapon_1H_norm_unique_07, new ItemPowerDescripter(446641, 1829442817, 1, 1.4, true) }, // Sword of Ill Will (446641) Chakram deals 1.0–1.4% increased damage for every point of Hatred you have.
            { SNOActor.XBow_norm_unique_03, new ItemPowerDescripter(374344, 1533314305, 1, 2, false) }, // Buriza-Do Kyanon (ItemPassive_Unique_XBow_011_x1) Your projectiles pierce 1–2 additional times.
            { SNOActor.healthPotion_Legendary_08_x1, new ItemPowerDescripter(428812, 1756415233, 3, 4, false) }, // Bottomless Potion of Fear (X1_Legendary_Potion_08) Fears enemies within 12 yards for 3–4 seconds.
            { SNOActor.p3_Bracers_norm_unique_02, new ItemPowerDescripter(441517, 1808454913, 30, 35, true) }, // Wraps of Clarity (P3_ItemPassive_Unique_Ring_038) Your Hatred Generators reduce your damage taken by 30–35% for 5 seconds.
            { SNOActor.x1_Belt_norm_unique_16, new ItemPowerDescripter(434038, 1777820929, 500, 650, true) }, // Sash of Knives (ItemPassive_Unique_Ring_753_p2) With every attack, you throw a dagger at a nearby enemy for 500–650% weapon damage as Physical.
            { SNOActor.Quiver_norm_unique_01, new ItemPowerDescripter(359605, 1472943361, 200, 250, true) }, // Meticulous Bolts (ItemPassive_Unique_Ring_749_x1) Elemental Arrow gains an effect based on the rune: Ball Lightning now travels at 30% speed. Frost Arrow damage and Chilled duration increased by 200–250%. Immolation Arrow ground damage over time increased by 200–250%. Lightning Bolts damage and Stun duration increased by 200–250%. Nether Tentacles damage and healing amount increased by 200–250%.
            { SNOActor.x1_Belt_norm_unique_15, new ItemPowerDescripter(318241, 1303516417, 300, 400, true) }, // Razor Strop (ItemPassive_Unique_Ring_500_x1) Picking up a Health Globe releases an explosion that deals 300–400% weapon damage as Fire to enemies within 20 yards.
            { SNOActor.Gloves_norm_unique_078, new ItemPowerDescripter(318731, 1305523457, 40, 50, true) }, // Tasker and Theo (ItemPassive_Unique_Ring_554_x1) Increase attack speed of your pets by 40–50%.
            { SNOActor.XBow_norm_unique_06, new ItemPowerDescripter(446318, 1828119809, 40, 50, true) }, // Manticore (446318) Reduces the Hatred cost of Cluster Arrow by 40–50%.
            { SNOActor.x1_Bracers_norm_unique_13, new ItemPowerDescripter(318818, 1305879809, 25, 30, true) }, // Reaper's Wraps (ItemPassive_Unique_Ring_636_x1) Health globes restore 25–30% of your primary resource.
            { SNOActor.Mojo_norm_unique_08, new ItemPowerDescripter(445765, 1825854721, 45, 60, true) }, // Vile Hive (445765) Locust Swarm gains the effect of the Pestilence rune and deals 45–60% increased damage.
            { SNOActor.ceremonialDagger_norm_unique_03, new ItemPowerDescripter(447030, 1831036161, 15, 20, false) }, // Last Breath (447030) Reduces cooldown of Mass Confusion by 15–20 seconds.
            { SNOActor.BarbBelt_norm_unique_02, new ItemPowerDescripter(318419, 1304245505, 4, 6, false) }, // Pride of Cassius (ItemPassive_Unique_Ring_530_x1) Increases the duration of Ignore Pain by 4–6 seconds.
            { SNOActor.x1_bow_norm_unique_09, new ItemPowerDescripter(318379, 1304081665, 3, 4, false) }, // Kridershot (ItemPassive_Unique_Ring_517_x1) Elemental Arrow now generates 3–4 Hatred.
            { SNOActor.x1_dagger_norm_unique_08, new ItemPowerDescripter(445274, 1823843585, 160, 200, true) }, // Lord Greenstone's Fan (445274) Every second, gain 160–200% increased damage for your next Fan of Knives. Stacks up to 30 times.
            { SNOActor.chestArmor_norm_unique_047, new ItemPowerDescripter(449064, 1839367425, 90, 95, true) }, // Aquila Cuirass (449064) While above 90–95% primary resource, all damage taken is reduced by 50%.
            { SNOActor.chestArmor_norm_unique_049, new ItemPowerDescripter(318790, 1305765121, 23, 30, true) }, // Cindercoat (ItemPassive_Unique_Ring_608_x1) Reduces the resource cost of Fire skills by 23–30%.
            { SNOActor.p4_Belt_norm_unique_02, new ItemPowerDescripter(449048, 1839301889, 50, 65, true) }, // Hergbrash’s Binding (449048) Reduces the Arcane Power cost of Arcane Torrent, Disintegrate, and Ray of Frost by 50–65%.
            { SNOActor.x1_Helm_norm_unique_14, new ItemPowerDescripter(318857, 1306039553, 15, 20, true) }, // Deathseer's Cowl (ItemPassive_Unique_Ring_662_x1) 15–20% chance on being hit by an Undead enemy to charm it for 2 seconds.
            { SNOActor.x1_fistWeapon_norm_unique_14, new ItemPowerDescripter(318432, 1304298753, 30, 35, false) }, // Jawbreaker (ItemPassive_Unique_Ring_539_x1) When Dashing Strike hits an enemy more than 30–35 yards away, its Charge cost is refunded.
            { SNOActor.p1_Belt_norm_unique_01, new ItemPowerDescripter(359554, 1472734465, 3000, 4000, true) }, // Crashing Rain (ItemPassive_Unique_Ring_709_x1) Rain of Vengeance also summons a crashing beast that deals 3000–4000% weapon damage.
            { SNOActor.Gloves_norm_unique_043, new ItemPowerDescripter(318349, 1303958785, 15, 20, true) }, // Frostburn (ItemPassive_Unique_Ring_505_x1) Cold skills deal 15–20% increased damage and have a 50% chance to Freeze enemies.
            { SNOActor.p4_Ring_norm_unique_02, new ItemPowerDescripter(446187, 1827583233, 50, 60, true) }, // Elusive Ring (446187) After casting Shadow Power, Smoke Screen, or Vault, take 50–60% reduced damage for 8 seconds.
            { SNOActor.Ring_norm_unique_008, new ItemPowerDescripter(446565, 1829131521, 45, 55, true) }, // Justice Lantern (446565) Gain damage reduction equal to 45–55% of your Block Chance.            
            { SNOActor.x1_BarbBelt_norm_unique_14, new ItemPowerDescripter(446639, 1829434625, 8, 9, true) }, // Zoey's Secret (446639) You take 8.0–9.0% less damage for every Companion you have active.
            { SNOActor.x1_Belt_norm_unique_18, new ItemPowerDescripter(434008, 1777698049, 3, 4, false) }, // Cord of the Sherma (ItemPassive_Unique_Ring_560_p2) Chance on hit to create a chaos field that Blinds and Slows enemies inside for 3–4 seconds.
            { SNOActor.x1_twoHandedMace_norm_unique_08, new ItemPowerDescripter(318753, 1305613569, 40, 50, true) }, // The Furnace (ItemPassive_Unique_Ring_571_x1) Increases damage against elites by 40–50%.
            { SNOActor.p2_twoHandedSword_norm_unique_02, new ItemPowerDescripter(402455, 1648456961, 5000, 6000, true) }, // Corrupted Ashbringer (ItemPassive_Unique_Ring_916_x1) Chance on kill to raise a skeleton to fight for you. Upon accumulating 5 skeletons, they each explode for 1000% weapon damage and the sword transforms into Ashbringer for a short time. Attacking with Ashbringer burns your enemy for 5000–6000% weapon damage as Holy.
            { SNOActor.x1_Bracers_norm_unique_19, new ItemPowerDescripter(430289, 1762465025, 30, 40, true) }, // Spirit Guards (P2_ItemPassive_Unique_Ring_034) Your Spirit Generators reduce your damage taken by 30–40% for 3 seconds.
            { SNOActor.p4_Bracers_norm_unique_05, new ItemPowerDescripter(447295, 1832121601, 125, 150, true) }, // Pinto's Pride (447295) Wave of Light also Slows enemies by 80% for 3 seconds and deals 125–150% increased damage.
            { SNOActor.fistWeapon_norm_unique_03, new ItemPowerDescripter(451168, 1847985409, 75, 100, true) }, // Fleshrake (451168) Dashing Strike increases the damage of Dashing Strike by 75–100% for 1 second, stacking up to 5 times.
            { SNOActor.p3_Bracers_norm_unique_01, new ItemPowerDescripter(449222, 1840014593, 150, 200, true) }, // Bindings of the Lesser Gods (449222) Enemies hit by your Cyclone Strike take 150–200% increased damage from your Mystic Ally for 5 seconds.
            { SNOActor.x1_shoulderPads_norm_unique_08, new ItemPowerDescripter(449236, 1840071937, 40, 50, true) }, // Lefebvre’s Soliloquy (449236) Cyclone Strike reduces your damage taken by 40–50% for 5 seconds.
            { SNOActor.p4_Bracers_norm_unique_07, new ItemPowerDescripter(449031, 1839232257, 300, 400, true) }, // Cesar’s Memento (449031) Enemies take 300–400% increased damage from your Tempest Rush for 5 seconds after you hit them with a Blind, Freeze, or Stun.
            { SNOActor.x1_Sword_norm_unique_12, new ItemPowerDescripter(318763, 1305654529, 279, 372, true) }, // Thunderfury, Blessed Blade of the Windseeker (ItemPassive_Unique_Ring_581_x1) Chance on hit to blast your enemy with Lightning, dealing 279–372% weapon damage as Lightning and then jumping to additional nearby enemies. Each enemy hit has their attack speed and movement speed reduced by 30% for 3 seconds. Jumps up to 5 targets.
            { SNOActor.p3_Belt_norm_unique_03, new ItemPowerDescripter(440598, 1804690689, 3, 3.5, true) }, // Binding of the Lost (P3_ItemPassive_Unique_Ring_027) Each hit with Seven-Sided Strike grants 3.0–3.5% damage reduction for 7 seconds.
            { SNOActor.x1_dagger_norm_unique_07, new ItemPowerDescripter(445279, 1823864065, 10, 15, false) }, // Karlei's Point (445279) Impale returns 10–15 Hatred if it hits an enemy already Impaled.
            { SNOActor.p2_shoulderPads_norm_unique_03, new ItemPowerDescripter(446640, 1829438721, 20, 25, true) }, // Mantle of Channeling (446640) While channeling Whirlwind, Rapid Fire, Strafe, Tempest Rush, Firebats, Arcane Torrent, Disintegrate, or Ray of Frost, you deal 20–25% increased damage and take 25% reduced damage.
            { SNOActor.orb_norm_unique_01, new ItemPowerDescripter(318793, 1305777409, 15, 20, true) }, // Winter Flurry (ItemPassive_Unique_Ring_611_x1) Enemies killed by Cold damage have a 15–20% chance to release a Frost Nova.
            { SNOActor.orb_norm_unique_04, new ItemPowerDescripter(434849, 1781142785, 150, 200, true) }, // Triumvirate (P2_ItemPassive_Unique_Ring_052) Your Signature Spells increase the damage of Arcane Orb by 150–200% for 6 seconds, stacking up to 3 times.
            { SNOActor.x1_Sword_norm_unique_23, new ItemPowerDescripter(449063, 1839363329, 30, 35, true) }, // Deathwish (449063) While channeling Arcane Torrent, Disintegrate, or Ray of Frost, all damage is increased by 30–35%.
            { SNOActor.x1_Amulet_norm_unique_19, new ItemPowerDescripter(318381, 1304089857, 20, 25, true) }, // Countess Julia's Cameo (ItemPassive_Unique_Ring_519_x1) Prevent all Arcane damage taken and heal yourself for 20–25% of the amount prevented.
            { SNOActor.x1_Amulet_norm_unique_24, new ItemPowerDescripter(318410, 1304208641, 3, 4, true) }, // Rakoff's Glass of Life (ItemPassive_Unique_Ring_525_x1) Enemies you kill have a 3–4% additional chance to drop a health globe.
            { SNOActor.x1_Amulet_norm_unique_20, new ItemPowerDescripter(318759, 1305638145, 60, 80, true) }, // The Ess of Johan (ItemPassive_Unique_Ring_577_x1) Chance on hit to pull in enemies toward your target and Slow them by 60–80%.
            { SNOActor.x1_Amulet_norm_unique_21, new ItemPowerDescripter(334880, 1371669761, 4, 6, false) }, // Golden Gorget of Leoric (ItemPassive_Unique_Amulet_105_x1) After earning a massacre bonus, 4–6 Skeletons are summoned to fight by your side for 10 seconds.
            { SNOActor.Bracers_norm_unique_04, new ItemPowerDescripter(449043, 1839281409, 75, 100, true) }, // Ashnagarr’s Blood Bracer (449043) Increases the potency of your shields by 75–100%.
            { SNOActor.twoHandedSword_norm_unique_06, new ItemPowerDescripter(364321, 1492260097, 20, 45, true) }, // Scourge (ItemPassive_Unique_Sword_2H_004_x1) 20–45% chance when attacking to explode with demonic fury for 1800-2000% weapon damage as Fire.
            { SNOActor.Ring_norm_unique_018, new ItemPowerDescripter(402460, 1648477441, 10, 12, false) }, // Nagelring (ItemPassive_Unique_Ring_921_x1) Summons a Fallen Lunatic to your side every 10–12 seconds.
            { SNOActor.x1_Axe_norm_unique_08, new ItemPowerDescripter(447029, 1831032065, 100, 125, false) }, // Mordullu's Promise (447029) Firebomb generates 100–125 Mana.
            { SNOActor.x1_Sword_norm_unique_18, new ItemPowerDescripter(446195, 1827616001, 125, 150, true) }, // The Twisted Sword (446195) Energy Twister damage is increased by 125–150% for each Energy Twister you have out up to a maximum of 8.
            { SNOActor.wizardHat_norm_unique_03, new ItemPowerDescripter(440336, 1803617537, 15, 20, false) }, // The Swami (P3_ItemPassive_Unique_Ring_022) The bonuses from Archon stacks now last for 15–20 seconds after Archon expires.
            { SNOActor.x1_Boots_norm_unique_04, new ItemPowerDescripter(318877, 1306121473, 25, 30, true) }, // Irontoe Mudsputters (ItemPassive_Unique_Ring_681_x1) Gain up to 25–30% increased movement speed based on amount of Life missing.
            { SNOActor.shoulderPads_norm_unique_02, new ItemPowerDescripter(434005, 1777685761, 25, 35, true) }, // Death Watch Mantle (ItemPassive_Unique_Shoulder_002_p2) 25–35% chance to explode in a fan of knives for 750-950% weapon damage when hit.
            { SNOActor.p2_Helm_norm_unique_02, new ItemPowerDescripter(449049, 1839305985, 45, 60, true) }, // Warhelm of Kassar (449049) Reduce the cooldown and increase the damage of Phalanx by 45–60%.
            { SNOActor.twoHandedMace_norm_unique_07, new ItemPowerDescripter(434033, 1777800449, 650, 850, true) }, // Schaefer's Hammer (ItemPassive_Unique_Mace_2H_009_p2) Casting a Lightning skill charges you with Lightning, causing you to deal 650–850% weapon damage as Lightning every second for 5 seconds to nearby enemies.
            { SNOActor.x1_Ring_norm_unique_026, new ItemPowerDescripter(434036, 1777812737, 25, 35, true) }, // Wyrdward (ItemPassive_Unique_Ring_670_p2) Lightning damage has a 25–35% chance to Stun for 1.5 seconds.
            { SNOActor.x1_twoHandedSword_norm_unique_11, new ItemPowerDescripter(318412, 1304216833, 550, 700, true) }, // Stalgard's Decimator (ItemPassive_Unique_Ring_527_x1) Your melee attacks throw a piercing axe at a nearby enemy, dealing 550–700% weapon damage as Physical.
            { SNOActor.Ring_norm_unique_017, new ItemPowerDescripter(402461, 1648481537, 70, 85, true) }, // Oculus Ring (ItemPassive_Unique_Ring_922_x1) Chance to create an area of focused power on killing a monster. Damage is increased by 70–85% while standing in the area.
            { SNOActor.x1_bow_norm_unique_10, new ItemPowerDescripter(428220, 1753990401, 20, 25, true) }, // Odyssey's End (P2_ItemPassive_Unique_Ring_023) Enemies snared by your Entangling Shot take 20–25% increased damage from all sources.
        };
        ...
        public static readonly Dictionary<KeyValuePair<TrinityItemType, ItemProperty>, ItemStatRange> ItemPropertyLimitsByItemType = new Dictionary<KeyValuePair<TrinityItemType, ItemProperty>, ItemStatRange>
        {
            ...
            {new KeyValuePair<TrinityItemType, ItemProperty>(TrinityItemType.Phylactery, ItemProperty.PrimaryStat), new ItemStatRange {AncientMax = 1000, AncientMin = 825, Max = 750, Min = 626 }},
            ...
            {new KeyValuePair<TrinityItemType, ItemProperty>(TrinityItemType.Phylactery, ItemProperty.Vitality), new ItemStatRange {AncientMax = 1000, AncientMin = 825, Max = 750, Min = 626 }},
